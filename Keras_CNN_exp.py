...
model.add(Conv2D(32,(3,3),kernel_initializer='glorot_normal', bias_initializer=keras.initializers.Constant(0.1),padding='same'))
model.add(LeakyReLU())
model.add(normalization.BatchNormalization())
...
model.add(Dense(512,W_constraint=max_norm(3.)))
model.add(LeakyReLU())
